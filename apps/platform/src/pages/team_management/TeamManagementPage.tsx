...
import { useMemberQueries } from "../../features/members/useMemberQueries"

import { User, UserPlus, Shield, Edit3, Trash2, Users, Calendar } from "lucide-react"
...
const TeamManagementPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center">
        <div className="relative">
          ...
          <div className="mt-4 text-green-600 font-medium">Loading team data...</div>
        </div>
      </div>
    )
  }
  ...
  if (!user?.onboarded) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center p-6">
        <div className="bg-white/80 backdrop-blur-xl border border-red-200 rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          <Shield className="w-16 h-16 text-red-500 mx-auto mb-4" />
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Access Denied</h1>
          <p className="text-gray-600">Please complete your onboarding to access Manage Team.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen py-20 bg-gradient-to-br from-green-50 via-white to-emerald-50" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Manage your team members and permissions</p>
        </div>
          ...
          <div className="mb-8">
            <div className="bg-gradient-to-r from-green-100 to-emerald-100 border border-green-200 rounded-2xl p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Your Team Lead</h2>
                  <p className="text-green-600 text-sm font-medium">Administrative Contact</p>
                </div>
              </div>
            ...
            {members.length === 0 ? (
              <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-xl p-8 text-center shadow-sm">
                ...
                <p className="text-gray-600">
                  {isAdmin ? "Create your first member profile!" : "Contact your admin to be added."}
                </p>
              </div>
            ) : (
                      ...
                      <div className="flex-1">
                        <div className="flex items-center mb-2">
                          <div className={`p-2 rounded-lg mr-3 ${
                            member.type === 'Admin' ? 'bg-green-500' : 'bg-blue-500'
                          }`}>
                            {member.type === 'Admin' ? (
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-medium">{selectedMember.role}</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-200 space-y-3">
                    <div>
                      ...
                      <p className="text-gray-600 font-mono text-sm">{selectedMember.memberId}</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-500">Created</p>
                        <p className="text-gray-600 text-sm">{new Date(selectedMember.createdAt).toLocaleDateString()}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Updated</p>
                        <p className="text-gray-600 text-sm">{new Date(selectedMember.updatedAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {(isAdmin || isCreating) && (
                    <div>
                      ...
                      <select
                        value={formData.type}
                        onChange={(e) =>
                          setFormData({ ...formData, type: e.target.value as "Admin" | "Member" })
                        }
            ...
            {!selectedMember && !isCreating && !isEditing && (
              <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-xl p-12 text-center shadow-sm">
                ...
                <p className="text-gray-600 mb-4">Select a member from the list to view details</p>
                {isAdmin && (
                  <>
