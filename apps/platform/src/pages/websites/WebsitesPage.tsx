// WebsitesPage.tsx - Enhanced UI Design
          ...
          <div className="max-w-md w-full">
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-green-100/50 p-8 text-center">
              ...
              <p className="text-slate-600 mb-8">
                Please sign in to access your website snapshots and monitoring
                dashboard.
              </p>
              <Link
                to="/login"
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          <div className="text-center">
            ...
            <p className="text-slate-600">
              Fetching your monitoring dashboard...
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 p-4 py-24 max-w-7xl mx-auto">
        ...
        {filteredAndSortedWebsites && filteredAndSortedWebsites.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
            {filteredAndSortedWebsites.map((website: Website) => (
              <div
                key={website.id}
