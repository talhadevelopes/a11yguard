...
import SnapshotDisplay from "./_components/SnapshotDiff";
import { useWebsiteDetails } from "../../features/websiteDetails/useWebsiteDetails";
          ...
          <div className="max-w-md w-full">
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-green-100/50 p-8 text-center">
              ...
              <p className="text-slate-600 mb-6">
                Please login to view website details and snapshots.
              </p>
              <Link
                to="/login"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
              >
                Go to Login
              </Link>
              <div className="mt-6">
